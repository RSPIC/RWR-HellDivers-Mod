...
// base scritp
#include "path://media/packages/hell_diver_pvp/scripts/trackers/INFO.as"
#include "path://media/packages/hell_diver_pvp/scripts/trackers/debug_reporter.as"
#include "path://media/packages/hell_diver_pvp/scripts/core/all_parameter.as"
#include "path://media/packages/hell_diver_pvp/scripts/core/all_task.as"
#include "path://media/packages/hell_diver_pvp/scripts/core/all_helper.as"

#include "path://media/packages/hell_diver_pvp/scripts/trackers/basic_command_handler.as"
...
class UserSettings {
	...
	// --------------------------------------------
	UserSettings() {
		//m_overlayPaths.insertLast("media/packages/hell_diver_pvp/scripts/minimode");
	}
