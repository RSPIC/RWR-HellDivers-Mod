...
convert.exe _rwr_alpha_sand.png -alpha extract -depth 8 -gaussian-blur 6x6 terrain5_alpha_sand.png
...
convert.exe _rwr_alpha_rocky_mountain.png -alpha extract -depth 8 terrain5_alpha_rocky_mountain.png
convert.exe _rwr_alpha_dirtroad.png -alpha extract -depth 8 terrain5_alpha_dirtroad.png
