...
convert _map_composed4.png map_view_tile_dirtroad.png _map_dirtroad_mask.png -composite _map_composed5.png

rem road
convert _rwr_alpha_road.png -alpha extract -depth 8 _map_road_mask.png 
convert _map_composed5.png map_view_tile_road.png _map_road_mask.png -composite _map_composed6.png

rem map view decoration
composite -compose DstOver _map_composed6.png _rwr_map_view_bases.png _map_composed7.png
