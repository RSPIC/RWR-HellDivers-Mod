...
rem road
convert _rwr_alpha_muddyroad.png -alpha extract -depth 8 _map_road_mask.png 
...
composite -compose DstOver _map_composed4.png _rwr_map_view_decoration.png _map_composed5.png



rem objects
composite -compose DstOver _map_composed5.png _grey_objects.png _map_composed6.png 
