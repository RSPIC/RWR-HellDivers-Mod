...
rem woods
composite -compose Multiply _map_composed1.png _map_composed_woods.png _map_composed2.png

rem asphalt
convert _rwr_alpha_asphalt.png -alpha extract -depth 8 _map_asphalt_mask.png 
convert _map_composed2.png map_view_tile_asphalt.png _map_asphalt_mask.png -composite _map_composed3.png
