...
convert.exe _rwr_alpha_dirtroad.png -alpha extract -depth 8 -gaussian-blur 2x2 terrain5_alpha_dirtroad.png
convert.exe _rwr_alpha_asphalt.png -alpha extract -depth 8 -gaussian-blur 3x3 terrain5_alpha_asphalt.png
