...
class PenaltyManager : Tracker {
	...
	// --------------------------------------------
	PenaltyManager(GameModeInvasion@ metagame, int teamKillsToStartPenalty = 20, float penaltyTime = 1200.0, float forgiveTeamKillTime = 900.0, float persistentPenaltyTime = 1209600.0f) {
		@m_metagame = @metagame;
