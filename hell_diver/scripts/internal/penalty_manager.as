...
class PenaltyManager : Tracker {
	...
	// --------------------------------------------
	PenaltyManager(GameModeInvasion@ metagame, int teamKillsToStartPenalty = 5, float penaltyTime = 600.0, float forgiveTeamKillTime = 200.0, float persistentPenaltyTime = 1209600.0f) {
		@m_metagame = @metagame;
