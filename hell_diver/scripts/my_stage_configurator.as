...
class MyStageConfigurator : StageConfiguratorCampaign {
	...
	const array<FactionConfig@>@ getAvailableFactionConfigs() const {
		...
		availableFactionConfigs.push_back(FactionConfig(-1, "super_earth.xml", "SE", "1 0.6 0", "super_earth.xml"));
		availableFactionConfigs.push_back(FactionConfig(-1, "cyborgs.xml", "Cyb", "1 0.15 0.15", "cyborgs.xml"));
		availableFactionConfigs.push_back(FactionConfig(-1, "illuminate.xml", "Cyb", "0 0.3 1", "illuminate.xml"));
		availableFactionConfigs.push_back(FactionConfig(-1, "bugs.xml", "Cyb", "1 0.3 0", "bugs.xml"));
